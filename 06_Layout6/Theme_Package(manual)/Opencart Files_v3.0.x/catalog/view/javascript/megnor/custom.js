...
var widthClassOptions = ({
		...
		topcategory		 :'topcategory_default_width',
...
function mobileToggleColumn(){
	if ($(window).width() < 980)
	{
		...
		$('.header_bottom .header_center').insertAfter('.header_top .header-logo');
		$('.header_top .nav-container').insertBefore('.header_bottom .account');
		...
		$('.header_top .header_center').insertAfter('.header_bottom .box-category-top');
		$('.header_bottom .nav-container').insertAfter('.header_top .header-logo');
